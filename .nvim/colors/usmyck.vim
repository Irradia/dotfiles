...
hi StatusLine           cterm=none ctermbg=241      ctermfg=254     gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi StatusLineNC         cterm=none ctermbg=236      ctermfg=240     gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi VertSplit            cterm=none ctermbg=236      ctermfg=245     gui=none        guibg=#5D5D5D   guifg=#FBFBFB
...
hi Folded               cterm=none ctermbg=236      ctermfg=2       gui=none        guibg=#3B3B3B   guifg=#90AB41
hi FoldColumn           cterm=none ctermbg=236      ctermfg=2       gui=none        guibg=#3B3B3B   guifg=#90AB41
...
hi MatchParen           cterm=none ctermbg=7        ctermfg=15      gui=none        guibg=#2EB5C1   guifg=#F7F7F7
...
hi Title                cterm=none ctermbg=none     ctermfg=5       gui=none                        guifg=#88CCE7
hi TabLine              cterm=none ctermbg=none     ctermfg=7       gui=none                        guifg=#88CCE7
hi TabLineFill          cterm=none ctermbg=none     ctermfg=none    gui=none                        guifg=#88CCE7
hi TabLineSel           cterm=none ctermbg=none     ctermfg=13      gui=none                        guifg=#88CCE7
